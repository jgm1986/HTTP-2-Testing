...
<div class="jumbotron">
	<div class="container">
		<h1>Template 08&nbsp;<small>Upload image to the server.</small></h1>
	</div>
</div>
...
<div  align="middle" class="container">
  	<hr>
    	<p>This is the data uploaded to the HTTP/2 test server:</p>
		<?php
		...
		if(is_uploaded_file($_FILES['imageFile']['tmp_name'])){
			...
			echo "</ul>";
			move_uploaded_file($_FILES['imageFile']['tmp_name'], "tmp/08_img");
			echo "<img class=\"img-responsive\" src=tmp/08_img><br>";
		} else {
			echo "<li>File NOT uploaded";
			echo "</ul>";
		}
		echo "<div class=\"alert alert-success\" role=\"alert\">";
        	echo "<strong>FILE data output:</strong><br>";
